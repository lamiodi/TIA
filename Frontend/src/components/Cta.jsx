...
const Cta = () => {
  return (
    <div className="container-padding custom-gradient relative flex flex-col lg:flex-row items-center justify-between w-full aspect-[2/1.8] sm:aspect-[2/1.5] lg:max-h-[530px] xl:max-h-[630px] 2xl:max-h-[970px] overflow-hidden">
